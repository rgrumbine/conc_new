...
// New team2 4 May 2023 -- to work from lr, hr spots as accumulated:
float nasa_team2(amsr2_lr_accum &lr, amsr2_hr_accum &hr, amsr_team2_tables &tab, float lat) ;
...
//    float x = 999, y=999;
    ...
    // Pull frequencies needed by team2 from the accumulation points:
    float v19, h19, v24, v37, h37, v89, h89;
    v19 = lr.lr[AMSR2_T19V].spot.tmbr;
    h19 = lr.lr[AMSR2_T19H].spot.tmbr;
    v24 = lr.lr[AMSR2_T24V].spot.tmbr;
    v37 = lr.lr[AMSR2_T37V].spot.tmbr;
    h37 = lr.lr[AMSR2_T37H].spot.tmbr;
    v89 = hr.hr[AMSR2_T89V].spot.tmbr;
    h89 = hr.hr[AMSR2_T89H].spot.tmbr;
